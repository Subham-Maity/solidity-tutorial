...
<p align="center">
        <img src="https://github.com/Subham-Maity/solidity-tutorial/blob/master/Image(ignore)/50.png?raw=true"/>
        </p>

<p align="center">
        <img src="https://github.com/Subham-Maity/solidity-tutorial/blob/master/Image(ignore)/51.png?raw=true"/>
        </p>

**1.When you declare a public state variable a getter function is automatically created.**

**2.When you call a setter function it creates a transaction that needs to be mined and costs gas because it changes the blockchain. Vice versa for getter function.**
